...
echo "== pytest =="
python3 -m pytest -q -o cache_dir=/tmp/energy_brain_v2160_pytest_cache
echo "PASS: pytest"
...
echo "== V2160 focused tests =="
python3 -m pytest -q -o cache_dir=/tmp/energy_brain_v2160_pytest_cache tests/test_v2160_v2191_predbat_inspired_layperson_planner_cockpit.py
echo "PASS: V2160 focused tests"
...
tests/test_v2160_v2191_predbat_inspired_layperson_planner_cockpit.py
...
for path in ${SCAN_FILES}; do
  ...
  if [ "${path}" = "tools/run_v2160_v2191_predbat_inspired_layperson_planner_cockpit_smoke.sh" ]; then
...
echo "PASS: V2160-V2191 Predbat-inspired layperson planner cockpit smoke"
