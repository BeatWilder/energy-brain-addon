...
echo "== pytest =="
python3 -m pytest -q -o cache_dir=/tmp/energy_brain_v2288_pytest_cache
echo "PASS: pytest"
...
run_if_present tools/run_v2256_v2287_predbat_ux_reverse_spec_no_code_copy_smoke.sh "V2256 smoke"

echo "== V2288 focused tests =="
python3 -m pytest -q -o cache_dir=/tmp/energy_brain_v2288_pytest_cache tests/test_v2288_v2319_predbat_style_energy_brain_plan_card.py
echo "PASS: V2288 focused tests"
...
tests/test_v2288_v2319_predbat_style_energy_brain_plan_card.py
...
for path in ${SCAN_FILES}; do
  ...
  if [ "${path}" = "tools/run_v2288_v2319_predbat_style_energy_brain_plan_card_smoke.sh" ]; then
...
echo "PASS: V2288-V2319 Predbat-style Energy Brain plan card smoke"
