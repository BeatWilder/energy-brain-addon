...
.grid-chip {
    box-shadow:
        0 0 18px rgba(90,255,190,0.18),
        0 0 34px rgba(90,255,190,0.14),
        inset 0 0 14px rgba(90,255,190,0.06) !important;

    border-color: rgba(110,255,200,0.22) !important;
}

.limit-chip {
    box-shadow:
        0 0 22px rgba(255,210,90,0.26),
        0 0 46px rgba(255,210,90,0.14) !important;
}

.powerflow-node {
    filter:
        drop-shadow(0 0 24px rgba(90,255,190,0.36))
        drop-shadow(0 0 44px rgba(90,255,190,0.20));
}

.powerflow-center {
    box-shadow:
        0 0 60px rgba(90,255,190,0.20),
        0 0 120px rgba(90,255,190,0.18),
        0 0 180px rgba(255,210,90,0.12),
...
.powerflow-line {
    filter:
        drop-shadow(0 0 12px rgba(90,255,190,0.32))
        drop-shadow(0 0 22px rgba(90,255,190,0.20));
}
...
.energy-node {
    filter:
        drop-shadow(0 0 18px rgba(90,255,180,0.45))
        drop-shadow(0 0 42px rgba(90,255,180,0.28))
        drop-shadow(0 0 90px rgba(90,255,180,0.18));
}
...
.battery-center {
    box-shadow:
        0 0 50px rgba(90,255,180,0.30),
        0 0 120px rgba(90,255,180,0.20),
        0 0 220px rgba(90,255,180,0.14),
...
.energy-flow-line {
    filter:
        drop-shadow(0 0 10px rgba(90,255,180,0.42))
        drop-shadow(0 0 22px rgba(90,255,180,0.22));
}
...
.house-chip {
    box-shadow:
        0 0 16px rgba(90,255,180,0.20),
        0 0 36px rgba(90,255,180,0.14) !important;
}
